...
import net.lirelab.collection.CollectionContextMenuFactory;
import net.lirelab.collection.CollectionService;
import net.lirelab.collection.Image;
import net.lirelab.custom.collection_detail.CollectionDetail;
import net.lirelab.custom.collection_tree.CollectionTree;
import net.lirelab.custom.image_viewer.ImageViewer;
...
public class HomeController implements Initializable {
    ...
    public void showCollectionImages(Collection collection) {
        centerPane.setCenter(new CollectionDetail(collection, asList(applicationCommands.getCollectionCommand(ApplicationCommands.CollectionCommand.SEARCH))));
    }
