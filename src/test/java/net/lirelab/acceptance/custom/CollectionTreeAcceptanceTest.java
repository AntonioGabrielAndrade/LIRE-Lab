...
public class CollectionTreeAcceptanceTest extends ApplicationTest {
    ...
    private static final Collection COLLECTION_1 = collection("Collection1", TEST_IMAGES, Feature.CEDD);
    private static final Collection COLLECTION_2 = collection("Collection2", TEST_IMAGES, Feature.CEDD);
    private static final Collection COLLECTION_3 = collection("Collection3", TEST_IMAGES, Feature.CEDD);
    private static final Collection COLLECTION_4 = collection("Collection4", TEST_IMAGES, Feature.CEDD);
