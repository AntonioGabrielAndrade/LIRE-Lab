...
package net.lirelab.custom.image_dialog;

import net.lirelab.app.ImageViewConfig;
...
public class ImageDialogTest {
    ...
    public void shouldLimitImageHeightToAMaximum() throws Exception {
        verify(imageViewConfig).limitImageHeight(imageView, ImageDialog.MAX_IMAGE_HEIGHT);
    }
    ...
    private void createDialog() {
        TestUtils.runOnFxThreadAndWait(() -> dialog =
