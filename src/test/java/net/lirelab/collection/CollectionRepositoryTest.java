...
public class CollectionRepositoryTest {
    ...
    public static void createCollections() throws Exception {
        COLLECTION_HELPER.createRealCollection(COLLECTION1_NAME, TEST_IMAGES, Feature.CEDD);
        COLLECTION_HELPER.createRealCollection(COLLECTION2_NAME, TEST_IMAGES, Feature.CEDD);
    ...
    public void shouldReturnSpecificCollectionFromDisk() throws Exception {
        ...
        assertTrue(collection.getFeatures().contains(Feature.CEDD));
    }
    ...
    public void shouldDeleteCollection() throws Exception {
        ...
        COLLECTION_HELPER.createRealCollection(testCollection, TEST_IMAGES, Feature.CEDD);
